  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      try {
        ...
        this.$message({
          message: this.hasCustomArtwork ? '作品更新成功！' : '作品上传成功！现在可以点击画作查看详情了。',
          type: 'success',
          duration: 3000
        });
        this.closeDialog();
    ...
    handleDelete() {
      this.$confirm('确定要删除当前作品吗？删除后将恢复默认展示。', '确认删除', {
        ...
        try {
          ...
          EventBus.$emit('resetPictureTexture', this.currentPicName);
